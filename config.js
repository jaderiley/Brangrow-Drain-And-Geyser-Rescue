...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "Brangrow Drain & Geyser Rescue",
    phone:     "+27 71 218 0093",
    whatsapp:  "+27 71 218 0093",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "Brangrow Drain & Geyser Rescue — Plumber in pretoria north",
    description: "Brangrow Drain & Geyser Rescue provides professional plumber in Pretoria North. 3 Google reviews. Call for a quote today.",
  ...
  // ─── CONTENT ─────────────────────────────────────────────
  content: {
    eyebrow:    "Plumber · Pretoria North & surrounds",
    heroTitle:  "Burst pipe? Blocked drain? <em>We will fix it fast.</em>",
    heroLead:   "Brangrow Drain & Geyser Rescue provides fast, reliable plumbing services for homes and businesses across Pretoria North and the surrounding areas. Emergency callouts welcome.",
    ...
    band: {
      ...
      alt:   "Brangrow Drain & Geyser Rescue team at work in Pretoria North",
      text:  "Fast, reliable plumbing — emergency callouts welcome."
    },

    // ─── AREAS BLURB ───────────────────────────────────────
    areasTitle: "Based in Pretoria North. Serving the wider area.",
    areasLead:  "We cover Pretoria, Centurion, Hatfield and the surrounding suburbs. Emergency callouts available throughout the area.",
